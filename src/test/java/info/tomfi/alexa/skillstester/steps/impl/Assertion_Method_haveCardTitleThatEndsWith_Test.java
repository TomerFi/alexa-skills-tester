...
/** Then response step, assertion method haveCardTitleThatEndsWith test cases. */
@Tag("unit-tests")
final class Assertion_Method_haveCardTitleThatEndsWith_Test extends AssertionMethodsFixtures {
  @Test
