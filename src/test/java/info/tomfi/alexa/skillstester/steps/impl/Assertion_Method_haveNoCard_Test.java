...
@Tag("unit-tests")
final class Assertion_Method_haveNoCard_Test extends AssertionMethodsFixtures {
  @Test
  void asserting_with_no_card_object_will_keep_ongoing_assertion(@Mock final Response response) {
