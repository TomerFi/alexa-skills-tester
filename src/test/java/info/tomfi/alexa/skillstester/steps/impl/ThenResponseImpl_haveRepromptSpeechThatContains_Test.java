...
/** Assertion method haveRepromptSpeechThatContains test cases. */
@ExtendWith(MockitoExtension.class)
@Tag("unit-tests")
final class ThenResponseImpl_haveRepromptSpeechThatContains_Test {
  @Mock Skill skill;
  ...
  @Test
  void asserting_reprompt_speech_contains_plain_text_will_keep_ongoing_assertion(
  ...
  @Test
  void asserting_reprompt_speech_contains_with_ssml_will_keep_ongoing_assertion(
      @Mock final Response response,
  ...
  @Test
  void asserting_reprompt_speech_contains_no_reprompt_object_will_throw_an_assertion_error(
      @Mock final Response response) {
    given(responseEnvelope.getResponse()).willReturn(response);
  ...
  @Test
  void asserting_reprompt_speech_contains_with_unknown_speech_type_will_throw_an_assertion_error(
      @Mock final Response response,
  ...
  @Test
  void asserting_reprompt_speech_contains_with_plain_text_with_wrong_text_throws_assertion_error(
      @Mock final Response response,
      @Mock final PlainTextOutputSpeech speech,
      @Mock final Reprompt reprompt) {
  ...
  @Test
  void asserting_reprompt_speech_contains_with_ssml_with_wrong_text_throws_assertion_error(
      @Mock final Response response,
      @Mock final SsmlOutputSpeech speech,
      @Mock final Reprompt reprompt) {
