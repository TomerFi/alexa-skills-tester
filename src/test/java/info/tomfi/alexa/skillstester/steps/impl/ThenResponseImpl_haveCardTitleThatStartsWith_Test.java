...
@Tag("unit-tests")
final class ThenResponseImpl_haveCardTitleThatStartsWith_Test {
  @Mock Skill skill;
  ...
  @Test
  void asserting_card_title_starts_with_simple_card_will_keep_ongoing_assertion(
  ...
  @Test
  void asserting_card_title_starts_with_standard_card_will_keep_ongoing_assertion(
  ...
  @Test
  void asserting_card_title_starts_with_no_card_object_will_throw_an_assertion_error(
  ...
  @Test
  void asserting_card_title_starts_with_unknown_card_type_will_throw_an_assertion_error(
  ...
  @Test
  void asserting_card_title_starts_with_simple_card_with_wrong_title_throws_assertion_error(
      @Mock final Response response, @Mock final SimpleCard card) {
    given(card.getTitle()).willReturn("great fake card title 1");
    given(response.getCard()).willReturn(card);
    given(responseEnvelope.getResponse()).willReturn(response);
  ...
  @Test
  void asserting_card_title_starts_with_standard_card_with_wrong_title_throws_assertion_error(
      @Mock final Response response, @Mock final StandardCard card) {
    given(card.getTitle()).willReturn("great fake card title 1");
    given(response.getCard()).willReturn(card);
    given(responseEnvelope.getResponse()).willReturn(response);
