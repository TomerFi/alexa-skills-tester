...
/** Then response step, assertion method haveCardTextThatStartsWith test cases. */
@Tag("unit-tests")
final class Assertion_Method_haveCardTextThatStartsWith_Test extends AssertionMethodsFixtures {
  @Test
